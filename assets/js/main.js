(function ($) {
	...
	/*--
		MailChimphttp://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef
		-----------------------------------*/
		$('#mc-form').ajaxChimp({
			language: 'en',
			callback: mailChimpResponse,
		// ADD YOUR MAILCHIMP URL BELOW HERE!
		url: 'https://kiryano.us4.list-manage.com/subscribe/post?u=8594cbc2bf9f38dc9bcdb06f4&amp;id=77d6d78efd'
