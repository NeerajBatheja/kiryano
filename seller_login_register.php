...
include_once("classes/sellerClass.php");
	...
	if(isset($_POST['login'])){
		...
		if($user1->validate($email,$pass) ==1){
			...
			echo "<script>window.location.href='seller_account.php';</script>";
	    				exit;
		}else{
...
<?php
	if(isset($_POST['register'])){
		...
		if($pass == $pass_C){
			...
			if($user1->insert($first,$last,$email,$pass)){
...
<head class="no-js" lang="zxx"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>Seller Login-Kiryano-Online Shopping in Pakistan:Grocery,Electronics,Fashion</title>
						...
						<div class="login-form">
							...
							<div class="row">
								<div class="col-md-6 col-12 mb-20">
									...
									<input class="mb-0" name="first" type="text" placeholder="First Name">
								</div>
								<div class="col-md-6 col-12 mb-20">
									<label>Last Name</label>
									<input class="mb-0" name="last" type="text" placeholder="Last Name">
								</div>
