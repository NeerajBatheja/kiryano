...
<meta http-equiv="X-UA-Compatible" content="Kiryano is Pakistan based online shopping store . Kiryano Serves  Gorcery, latest Mobiles, Appliances, Fashion Accessories, & more retail products available at Reasonable Price,Kiryano is Startup Of FAST-NUCES Students For Larkana People.">
	<title>Kiryano Scholarships-Kiryano-Online Shopping in Pakistan:Grocery,Electronics,Fashion</title>
 ...
 <body>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 mb-xs-35">
					...
					<div class="contact-page-side-content">
						...
						<div class="single-contact-block">
							<h5><B><img src="assets/images/icons/scholar.png" alt=""> <br><br></B></h5>
				...
				<div class="col-lg-9 col-md-8 pl-100 pl-xs-15">
					...
					<div class="contact-form-content"><br><br>
						<h3 class="contact-page-title">KIRYANO SCHOLARSHIPS</h3>
   ...
   <h4> <li>For Any Query Regarding Scholarships: <strong>SCHOLARSHIPS@KIRYANO.COM</strong</li><br></h4>
   <h5><strong>Keep Yourself Update Regarding Scholarships</strong></h5>
                                <div class="col-md-12 col-12 mb-20">
								<form name="scholarships" action="" method="post" >
									<label>Email Address*</label>
									<input class="mb-0" name='email' type="email" placeholder="Email Address" size="30" required >
									<br><br>
									<h4><strong><li>Why You Need kiryano Scholarship?</li></strong></h4>
									<label>Additional Note:</label>
									<input class="mb-0" name='addnote' type="text" placeholder="Tell Your Story" size="30" >
								
								</div>
								
								<div class="col-md-12">
									<button type="submit" name="scholarships" class="register-button mt-0">Submit</button><br><br>
									<?php
$check = session_start();
include_once("classes/userClass.php");
$user2 = new user();
if(isset($_POST['email']) || isset($_POST['addnote']) )
{
    $mail=$_POST['email'];
    $addnote = $_POST['addnote'];
    if($user2->scholarships_update($mail,$addnote))
    {
        echo'<font color="green">Thankyou For believing Us.</font>';
    }
