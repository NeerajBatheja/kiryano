...
<?php
	if(isset($_POST['register'])){
		...
		if($pass == $pass_C){
			...
			if($user1->insert($first,$email,$pass,$phone)){
...
?>
							...
							<?php  if($invalid_login)echo '<h5 style="color:red;">Either email or passwrod is wrong</h5>'; ?>
								...
								<div class="col-md-12 col-12 mb-20">
									...
									<input class="mb-0" name='Vmail' type="email" placeholder="Email Address" size="30" required>
								</div>
					...
					<form name="registration" action="" method="post">
						...
						<div class="login-form">
							...
							<div class="row">
								...
								<div class="col-md-6 mb-20">
									<label>Phone</label>
									<input class="mb-0" name="phone" type="tel" placeholder="03XXXXXXXXX"  size="12" title="please enter number in given pattern '03XXXXXXXXX'" required>
								</div>
