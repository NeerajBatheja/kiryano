...
<meta http-equiv="X-UA-Compatible" content="Kiryano is Pakistan based online shopping store . Kiryano Serves  Gorcery, latest Mobiles, Appliances, Fashion Accessories, & more retail products available at Reasonable Price,Kiryano is Startup Of FAST-NUCES Students For Larkana People.">
	<title>Kiryano Jobs-Kiryano-Online Shopping in Pakistan:Grocery,Electronics,Fashion</title>
 ...
 <body>
   ...
   <h4> <li>Send Your Resume at <strong>JOBS@KIRYANO.COM</strong</li><br></h4>
   <h5><strong>You Can Also Send Your CV Using Below Box</strong></h5>
                                <div class="col-md-12 col-12 mb-20">
								<form name="jobs" action="" method="post" >
									<label>e.CV link</label>
									<input class="mb-0" name='cv' type="text" placeholder="Provide Electronic CV" size="30" >
									<br><br>
									<h4><strong><li>Keep Updated:</li></strong></h4>
